...
const links = [
  ...
  { to: "/dashboard/career-chatbot", label: "AI Career Chatbot", icon: Bot },
  { to: "/dashboard/tasks", label: "Smart Task Manager", icon: ClipboardList },
  { to: "/dashboard/coding-profiles", label: "Coding Analyzer", icon: Code2 },
  { to: "/dashboard/company-prep", label: "Company Prep", icon: Building2 },
